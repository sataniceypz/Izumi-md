const { izumi, commands, mode, getJson, PREFIX, clockString, getUrl, parsedJid, isAdmin } = require("../lib/");
...
async function sendMenu(message, match) {
    try {
        ...
        else if (hrs < 17) wish = '🌞𝙂𝙤𝙤𝙙 𝘼𝙛𝙩𝙚𝙧𝙣𝙤𝙤𝙣';
        else if (hrs < 21) wish = '🔆𝙂𝙤𝙤𝙙 𝙀𝙫𝙚𝙣𝙞𝙣𝙜';
        else wish = '🌙𝙂𝙤𝙤𝙙 𝙉𝙞𝙜𝙝𝙩';
