...
async function serialize(msg, client) {
  ...
  msg.body =
    ...
    (msg.type === "listResponseMessage" &&
      msg.message[msg.type].singleSelectReply.selectedRowId) || // Handling list response messages
    (msg.type === "buttonsResponseMessage" &&
      msg.message[msg.type].selectedButtonId) || // Handling button response messages
    (msg.type === "templateButtonReplyMessage" &&
      msg.message[msg.type].selectedId) || // Handling template button reply messages
    (msg.type === "interactiveResponseMessage" &&
      msg.message[msg.type]?.singleSelectReply?.selectedRowId) || // Adjusted for interactive messages
